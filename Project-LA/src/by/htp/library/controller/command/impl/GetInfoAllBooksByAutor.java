...
public class GetInfoAllBooksByAutor implements Command {
	@Override
	public String execute(String request) throws ControllerLibraryException {
		...
		try {
			books = libraryService.getInfoAllBookByAutor(request);
		...
		stringBuilder.append("We have the following books by autor " + request + ": \n");
